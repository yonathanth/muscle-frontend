...
const Stock: React.FC = () => {
  ...
  // const handleEditItem = (newItem: StockItem) => {
  //   setStockData((prevStockData) => [...prevStockData, newItem]);
        ...
        <table className="w-full text-sm text-left text-gray-400">
          <thead className="bg-black border-t border-[#D9D9D93B] text-gray-300 uppercase">
            <tr>
              ...
              <th className="px-6 py-6">Pack Qty</th>
              <th className="px-6 py-6">Individual Qty</th>
            ...
            {stockData.length ? (
              stockData.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-2">{item.packs}</td>
